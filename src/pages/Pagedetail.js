                ...
                <div className="col-12 col-md-4">
                    ...
                    <div>
                        ...
                        <div className="row border">
                            ...
                            <div className="col-9">
                                <p className="font-weight-bold mt-2">12 cuotas de $xxxx</p>
                                <p className="text-muted">Precio financiado: $ 42.842,67 - CFT 25.74% - TEA 21.07%</p>
                            </div>
                        </div>
                        <div className="row border border-top-0">
                            ...
                            <div className="col-9">
                                <p className="font-weight-bold mt-2">18 cuotas de $xxxx</p>
                                <p className="text-muted">Precio financiado: $ 42.842,67 - CFT 25.74% - TEA 21.07%</p>
                            </div>
                        </div>
