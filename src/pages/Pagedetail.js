...
class PageDetail extends React.Component {
    ...
    onClickHandler = () => {
        ...
        let products = CartManager.getItem();
        ...
        if(this.state.product.discountPercentage > 0) {
            ...
            return (
                <div>
                    ...
                    <h4 className="text-center"><strike className="text-muted pr-3">${this.state.product.price}</strike><span className="text-success">{this.state.product.discountPercentage}%Off</span></h4>
                </div>
            );
        } else {
            return (
        ...
        return (
            ...
            <div className="container-fluid row mx-auto mt-4">
                ...
                <div className="col-12 col-md-4">
                    ...
                    <button onClick={this.onClickHandler} type="button" className="btn btn-success btn-lg btn-block mb-3 d-md-none">Comprar</button>
                    ...
                    <div className="container-fluid">
                        ...
                        <div className="row mb-4 border border-top-0">
                            <div className="col-3"><i className="fas fa-store fa-3x mt-3"></i></div>
                            <div className="col-9 pb-2">
                                <p className="pt-2">Retiro en la sucursal</p>
                                <a href="https://www.google.com.ar/maps/search/garbarino+bs+as/@-34.6171726,-58.4689384,12z" target="_blank" rel="noopener noreferrer">Ver sucursales más cercanas <i className="fas fa-chevron-right fa-sm"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
